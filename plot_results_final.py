...
def parser():
    ...
    parser.add_argument('--w', type=str, default='-1,-1')
    parser.add_argument('--var', type=str, default='0.1n1.0')
    parser.add_argument('--pair_pot', type=str, default='modelfeatures')
    parser.add_argument('--compat', type=str, default='potts')
    ...
    parser.add_argument('--annotation_method', type=str, default='random')
